...
export interface ApiKhoaHocKhoaHoc extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'khoa-hoc';
    pluralName: 'khoa-hocs';
    singularName: 'khoa-hoc';
  };
  options: {
  ...
  attributes: {
    ...
    hinh_anh: Schema.Attribute.Media<
      ...
      true
    >;
    hoc_phi: Schema.Attribute.BigInteger;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::khoa-hoc.khoa-hoc'
    > &
      Schema.Attribute.Private;
    mo_ta: Schema.Attribute.Text;
    noi_bat: Schema.Attribute.Boolean;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID;
    ten: Schema.Attribute.String;
    thoi_gian: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTinTucTinTuc extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    noi_dung: Schema.Attribute.Text;
    phu_de: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID;
...
export interface ApiTrangChuTrangChu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hinh_anh: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    noi_dung: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID;
    tieu_de: Schema.Attribute.String;
    tom_tat: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
